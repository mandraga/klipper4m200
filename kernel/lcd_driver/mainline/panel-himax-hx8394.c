...
#define DRV_NAME "panel-mtf0397swi-06"
...
/*
		display-timings {
			...
			timing0: timing0 {
				...
				vactive = <800>;
				hback-porch = <44>;
				hfront-porch = <(575 - 480 - 44 - 6)>; // calculate as needed
				hsync-len = <6>;
				vback-porch = <16>;
				vfront-porch = <(896 - 800 - 16 - 1)>; // calculate as needed
				vsync-len = <1>;
				hsync-active = <0>;
				vsync-active = <0>;
				de-active = <1>;
 ...
 */
static void mtf0397swi_init_sequence(struct mipi_dsi_multi_context *dsi_ctx)
{
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00,
				     0x00);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00,
				     0xA0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC4,
				     0x05,0x10,0x06,0x02,0x05,0x15,0x10,0x05,0x10,0x07,0x02,0x05,0x15,0x10);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC5, 0x46, 0x40, 0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xD8, 0xCF, 0xCF);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xD9, 0x47);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x81);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC4, 0x82);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xB0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC5, 0x04, 0xB8);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xBB);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC5, 0x80);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x82);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC4, 0x02);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xC6);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xB0, 0x03);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xD0, 0x40);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xD1, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x80);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCB, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x90);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCB, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xA0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCB, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xB0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCB, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xC0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCB, 0x05,0x05,0x05,0x05,0x05,0x05,0x00,0x00,0x00,0x00,0x05,0x05,0x00,0x05,0x05);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xD0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCB, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x05,0x05,0x05,0x05,0x05,0x05,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xE0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCB, 0x00,0x00,0x05,0x05,0x00,0x05,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xF0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCB, 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x80);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCC, 0x0E,0x10,0x0A,0x0C,0x02,0x04,0x00,0x00,0x00,0x00,0x2E,0x2D,0x00,0x29,0x2A);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x90);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCC, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0D,0x0F,0x09,0x0B,0x01,0x03,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xA0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCC, 0x00,0x00,0x2E,0x2D,0x00,0x29,0x2A,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xB0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCC, 0x0B,0x09,0x0F,0x0D,0x03,0x01,0x00,0x00,0x00,0x00,0x2D,0x2E,0x00,0x29,0x2A);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xC0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCC, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x0A,0x10,0x0E,0x04,0x02,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xD0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCC, 0x00,0x00,0x2D,0x2E,0x00,0x29,0x2A,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x80);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCE, 0x8B,0x03,0x18,0x8A,0x03,0x18,0x89,0x03,0x18,0x88,0x03,0x18);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x90);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCE, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xA0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCE, 0x38,0x07,0x05,0x00,0x00,0x18,0x00,0x38,0x06,0x05,0x01,0x00,0x18,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xB0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCE, 0x38,0x05,0x05,0x02,0x00,0x18,0x00,0x38,0x04,0x05,0x03,0x00,0x18,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xC0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCE, 0x38,0x03,0x05,0x04,0x00,0x18,0x00,0x38,0x02,0x05,0x05,0x00,0x18,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xD0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCE, 0x38,0x01,0x05,0x06,0x00,0x18,0x00,0x38,0x00,0x05,0x07,0x00,0x18,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x80);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCF, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x90);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCF, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xA0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCF, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCF, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xC0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xCF, 0x3D,0x02,0x15,0x20,0x00,0x00,0x01,0x81,0x00,0x03,0x08);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xB5);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC5, 0x00,0x6F,0xFF,0x00,0x6F,0xFF);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x90);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xF5, 0x02,0x11,0x02,0x11);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x90);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xF5, 0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xB8);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xF5, 0x00,0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x94);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xF5, 0x02);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xBA);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xF5, 0x03);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xB4);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC5, 0xC0);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xE1, 0x00,0x0C,0x12,0x0F,0x08,0x10,0x0b,0x0A,0x04,0x07,0x0D,0x07,0x0E,0x15,0x10,0x03);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xE2, 0x00,0x0C,0x12,0x0E,0x07,0x10,0x0b,0x09,0x04,0x07,0x0D,0x07,0x0E,0x15,0x10,0x03);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xB4);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x90);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC4, 0x52);

	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0xb9);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xb0, 0x51);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC1, 0xF0);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xF5, 0xC0);

	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0x00, 0x80);
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, 0xC4, 0x01);
